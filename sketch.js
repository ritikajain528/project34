...
function preload()
{
    backgroundImage=loadImage("image/Gamindbackground.png")
}
...
function setup() {
	...
	block10=new Block(370,350,30,40);
	block11=new Block(400,350,30,40);
	block12=new Block(430,350,30,40);
	block13=new Block(460,350,30,40);
	block14=new Block(380,350,30,40);
